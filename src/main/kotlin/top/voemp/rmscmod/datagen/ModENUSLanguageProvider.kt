...
class ModENUSLanguageProvider : FabricLanguageProvider {
    ...
    override fun generateTranslations(
        ...
        translationBuilder?.add("menu.rmscmod.editConfigScreen.confirmOverride.message", "The config with the same name already exists. This will override the current config. Are you sure?")
        translationBuilder?.add("menu.rmscmod.configListScreen.title", "Config List")
        translationBuilder?.add("menu.rmscmod.configListScreen.areaSelection", "Area Size: %s x %s x %s")
        translationBuilder?.add("menu.rmscmod.configListScreen.noAreaSelection", "No Area Selected")
        translationBuilder?.add("menu.rmscmod.configListScreen.switchSelection", "Switch Count: %s")
        translationBuilder?.add("menu.rmscmod.configListScreen.noSwitchSelection", "No Switch Selected")
